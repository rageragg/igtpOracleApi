...
CREATE OR REPLACE PACKAGE dsc_api_k_truck IS
    ...
    --
    K_STATUS_AVAILABLE      CONSTANT VARCHAR2(20)  := sys_k_constant.K_TYPE_ST_AVAILABLE;
    K_STATUS_MAINTENANCE    CONSTANT VARCHAR2(20)  := sys_k_constant.K_TYPE_ST_MAINTENANCE;
    K_STATUS_SERVING        CONSTANT VARCHAR2(20)  := sys_k_constant.K_TYPE_ST_SERVING;
    K_STATUS_DISCARDED      CONSTANT VARCHAR2(20)  := sys_k_constant.K_TYPE_ST_DISCARDED;
    K_STATUS_LOCATED        CONSTANT VARCHAR2(20)  := sys_k_constant.K_TYPE_ST_LOCATED;
    --
