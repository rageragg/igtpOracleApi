--------------------------------------------------------
--  DDL for View VIE_PROVINCES_REGIONS
--------------------------------------------------------

CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "IGTP"."V_PROVINCES_REGIONS" (
      "PROVINCE_ID", "PROVINCE_DESC", "PROVINCE_CO", "SLUG", "REGION_ID", "REGION_CO", 
      "REGION_DESC", "COUNTRY_ID", "COUNTRY_CO", "COUNTRY_DESC"
  ) AS 
