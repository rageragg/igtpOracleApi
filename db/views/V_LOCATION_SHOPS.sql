...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "IGTP"."V_LOCATION_SHOPS" ("SHOP_CO", "SHOP_DESC", "NAME_CONTACT", "EMAIL_CONTACT", "TELEPHONE_CONTACT", "LOCATION_CO", "LOCATION_DESC", "CITY_CO", "CITY_DESC", "POSTAL_CO") AS 
