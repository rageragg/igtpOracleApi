...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "IGTP"."V_LOCATION_CITIES" ("LOCATION_ID", "LOCATION_CO", "LOCATION_DESC", "POSTAL_CO", "SLUG", "UUID", "CITY_DESC", "CITY_ID", "CITY_CO") AS 
