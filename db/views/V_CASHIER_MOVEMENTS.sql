...
CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "IGTP"."V_CASHIER_MOVEMENTS" (
  "ID", "CASHIER_ID", "MOVEMENT_AT", "MOVEMENT_CO", "MOVEMENT_REFERENCE", 
  "TYPE_CASHIER_MOVEMENT_ID", "CASHIER_MOVEMENT_DE", "DEBIT", "CREDIT", 
  "TRANSFER_ID", "TRANSFER_ORDER", "EMPLOYEE_ID", "EMPLOYEE_DE"
) AS 
