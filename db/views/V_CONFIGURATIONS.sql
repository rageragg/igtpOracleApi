...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "IGTP"."V_CONFIGURATIONS" ("LOCAL_CURRENCY_CO", "FOREIGN_CURRENCY_CO", "LAST_FOREIGN_CURRENCY_Q_DATE", "LAST_FOREIGN_CURRENCY_Q_VALUE", "COUNTRY_CO", "COMPANY_DESCRIPTION", "COMPANY_TELEPHONE_CO", "COMPANY_EMAIL", "DAYS_PER_YEAR", "WEEKS_PER_YEAR", "MONTHS_PER_YEAR", "DAYS_PER_MONTH", "DAYS_PER_WEEK", "HOURS_PER_DAY", "HOURS_PER_WEEK", "HOURS_PER_MONTH") AS 
