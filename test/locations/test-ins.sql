...
BEGIN 
    ...
    -- TEST DE PROCESO DE INCLUIR UNA LOCACION
    --
    ...
    r_locacion_data.p_postal_co   := '0000';
    r_locacion_data.p_city_co     := 'ACGUA';
    r_locacion_data.p_uuid        := NULL;
    r_locacion_data.p_slug        := NULL;
    r_locacion_data.p_nu_gps_lat  := 0.000;
    r_locacion_data.p_nu_gps_lon  := 0.000;
    r_locacion_data.p_user_co     := 'RGUERRA';
    --
    --
    dbms_output.put_line( '2.- Incluir Locacion');
    igtp.prs_k_api_location.create_location(
