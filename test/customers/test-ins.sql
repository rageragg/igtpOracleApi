...
BEGIN 
    ...
    r_customer_data.customer_co           := 'CSV';
    r_customer_data.description           := 'COMERCIAL SEVICA.';
    r_customer_data.telephone_co          := '251-0000000';
    r_customer_data.fax_co                := '';
    r_customer_data.email                 := 'diego@gmail.com';
    r_customer_data.address               := 'MERCABAR - ELIMINAR';
    r_customer_data.k_type_customer       := 'M';
    r_customer_data.k_sector              := 'FOODS';
    ...
    r_customer_data.name_contact          := 'DIEGO CHIRINOS';
    r_customer_data.email_contact         := 'diego@gmail.com';
