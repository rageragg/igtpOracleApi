...
BEGIN 
    ...
    l_reg_route.description         := 'CHIVACOA - CARORA';
    l_reg_route.route_co            := l_reg_from_city.id ||'-'||l_reg_to_city.id;
    l_reg_route.k_level_co          := 'A';
    l_reg_route.distance_km         :=  160.4;
    l_reg_route.estimated_time_hrs  :=  2;
    l_reg_route.slug                :=  'chva-caro';
