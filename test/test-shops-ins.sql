DECLARE 
    ...
    */
    ...
    l_reg_shops      cities%ROWTYPE      := NULL;
    --
BEGIN 
    --
    -- TODO: validaciones de que exista la localidad
    l_reg_location.location_co := 'BAR-BAR-1';
    ...
    l_reg_shops.shop_co         := '';
    l_reg_shops.description     := 'SHOP';
    l_reg_shops.location_id     := l_reg_location.id;
    l_reg_shops.address         := 'Direccion';
    --
    ...
    l_reg_shops.name_contact	    := 'contacto';
    ...
    --
    cfg_api_k_shop.ins( p_rec => l_reg_location );
    --
    COMMIT;
    --
