create or replace trigger tr_constructors_cti
    ...
    type constructors_tt is table of constructors_jn%rowtype index by pls_integer;
    --
    ...
    begin
        ...
        g_constructors_jn(g_constructors_jn.count + 1) := l_constructor;
        --
    end after each row;
    --
    ...
    begin
        --
        forall indx in g_constructors_jn.first .. g_constructors_jn.last
            --
            insert into constructors_jn values g_constructors_jn( indx );
            --
    end after statement;
    --
